...
def res(jobfile):
    ...
    Resumes = []
    Temp_pdf = []
    os.chdir('/home/i346303/Automated-Resume-Screening-System-master/Original_Resumes')
    ...
    Job_Desc = 0
    LIST_OF_TXT_FILES = []
    os.chdir('/home/i346303/Automated-Resume-Screening-System-master/Job_Description')
    f = open(jobfile,'r')
    text = f.read()
    ...
    for i in Resumes:
        ...
        text = i
        tttt = str(text)
        print("TTTT before is",tttt)
        tttt=  os.system('python parser.py config.xml tttt')
