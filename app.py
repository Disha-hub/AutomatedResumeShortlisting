...
def home():
    x = []
    for file in glob2.glob("/home/i346303/Automated-Resume-Screening-System-master-final/Job_Description/*.txt"):
        res = jd(file)
...
def custom_static(filename):
    return send_from_directory('/home/i346303/Automated-Resume-Screening-System-master-final/Original_Resumes', filename)
...
if __name__ == '__main__':
   # app.run(debug = True) 
    ...
    #app.run('0.0.0.0' , 5000 , debug=True , threaded=True)
     app.run('mo-653f5bebe.mo.sap.corp' , 5000 , debug=True)